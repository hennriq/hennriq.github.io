...
Site pessoal e profissional hospedado no GitHub Pages.
...
Abra o arquivo `index.html` em um navegador ou sirva a pasta com qualquer servidor estático.
...
As alterações podem ser publicadas diretamente no branch padrão do GitHub Pages após commit e push.
